...
const TeacherDetails = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        data.append("student", false); // Set to false for teacher
        ...
        try {
            const response = await axios.post(`${config.base_url}/teacher/`, data, {
                headers: {
    ...
    return (
        <div className="flex justify-center items-center h-screen bg-gray-100">
            <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
                <h2 className="text-2xl font-bold text-center mb-6">Teacher Details</h2>
